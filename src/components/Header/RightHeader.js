...
export const RightHeader = ({logclose,userlog}) => {
  ...
  return (
    ...
    >
        ...
        {
         account ? <NavLink to="/buynow"><DashboardCustomizeIcon style={{fontSize:20,marginRight:2}}/>DashBoard
         <StarBorderPurple500Icon className='start'/></NavLink> :""
        }
